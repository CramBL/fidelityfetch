...
- `clap`: 4.5.48 → 4.5.60 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `clap_complete`: 4.5.58 → 4.6.0 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `tokio`: 1.47.1 → 1.50.0 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `tracing-subscriber`: 0.3.20 → 0.3.23 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `mdns-sd`: 0.15.1 → 0.18.2 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `chrono`: 0.4.42 → 0.4.44 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `futures-util`: 0.3.31 → 0.3.32 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `strum`: 0.27.2 → 0.28.0 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `tempfile`: 3.23.0 → 3.27.0 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
- `axum-test`: 18.1.0 → 19.1.1 ([#160](https://github.com/CramBL/fidelityfetch/pull/160))
