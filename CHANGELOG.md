...
- `clap`: 4.5.48 → 4.5.60 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `clap_complete`: 4.5.58 → 4.5.66 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `tokio`: 1.47.1 → 1.50.0 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `mdns-sd`: 0.15.1 → 0.18.1 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `chrono`: 0.4.42 → 0.4.44 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `futures-util`: 0.3.31 → 0.3.32 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `strum`: 0.27.2 → 0.28.0 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `tempfile`: 3.23.0 → 3.26.0 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
- `axum-test`: 18.1.0 → 19.1.1 ([#159](https://github.com/CramBL/fidelityfetch/pull/159))
