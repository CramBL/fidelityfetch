...
- `clap`: 4.5.48 → 4.5.60 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `clap_complete`: 4.5.58 → 4.6.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `tokio`: 1.47.1 → 1.51.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `tracing-subscriber`: 0.3.20 → 0.3.23 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `local-ip-address`: 0.6.5 → 0.6.11 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `mdns-sd`: 0.15.1 → 0.19.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `chrono`: 0.4.42 → 0.4.44 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `futures-util`: 0.3.31 → 0.3.32 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `strum`: 0.27.2 → 0.28.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `tempfile`: 3.23.0 → 3.27.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
- `axum-test`: 18.1.0 → 20.0.0 ([#161](https://github.com/CramBL/fidelityfetch/pull/161))
