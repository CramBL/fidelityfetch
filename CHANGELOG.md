...
- `clap`: 4.5.48 → 4.5.53 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `clap_complete`: 4.5.58 → 4.5.61 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `axum`: 0.8.6 → 0.8.7 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `tracing`: 0.1.41 → 0.1.43 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `tracing-subscriber`: 0.3.20 → 0.3.22 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `tracing-journald`: 0.3.1 → 0.3.2 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
- `axum-test`: 18.1.0 → 18.3.0 ([#139](https://github.com/CramBL/fidelityfetch/pull/139))
