...
- `clap`: 4.5.48 → 4.5.60 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `clap_complete`: 4.5.58 → 4.6.1 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `tokio`: 1.47.1 → 1.50.0 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `tracing-subscriber`: 0.3.20 → 0.3.23 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `local-ip-address`: 0.6.5 → 0.6.11 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `mdns-sd`: 0.15.1 → 0.19.0 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `chrono`: 0.4.42 → 0.4.44 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `futures-util`: 0.3.31 → 0.3.32 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `strum`: 0.27.2 → 0.28.0 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `tempfile`: 3.23.0 → 3.27.0 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
- `axum-test`: 18.1.0 → 20.0.0 ([#164](https://github.com/CramBL/fidelityfetch/pull/164))
