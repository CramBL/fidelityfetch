...
- `clap`: 4.5.48 → 4.5.60 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
- `clap_complete`: 4.5.58 → 4.5.66 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
- `mdns-sd`: 0.15.1 → 0.18.0 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
- `futures-util`: 0.3.31 → 0.3.32 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
- `strum`: 0.27.2 → 0.28.0 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
- `tempfile`: 3.23.0 → 3.25.0 ([#157](https://github.com/CramBL/fidelityfetch/pull/157))
