...
- `clap`: 4.5.48 → 4.5.60 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `clap_complete`: 4.5.58 → 4.5.66 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `mdns-sd`: 0.15.1 → 0.18.1 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `chrono`: 0.4.42 → 0.4.44 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `futures-util`: 0.3.31 → 0.3.32 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `strum`: 0.27.2 → 0.28.0 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `tempfile`: 3.23.0 → 3.26.0 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
- `axum-test`: 18.1.0 → 19.0.0 ([#158](https://github.com/CramBL/fidelityfetch/pull/158))
