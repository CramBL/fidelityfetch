...
- `clap`: 4.5.48 → 4.5.60 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `clap_complete`: 4.5.58 → 4.6.2 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `axum`: 0.8.6 → 0.8.9 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `tokio`: 1.47.1 → 1.50.0 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `tracing-subscriber`: 0.3.20 → 0.3.23 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `local-ip-address`: 0.6.5 → 0.6.12 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `mdns-sd`: 0.15.1 → 0.19.1 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `chrono`: 0.4.42 → 0.4.44 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `futures-util`: 0.3.31 → 0.3.32 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `strum`: 0.27.2 → 0.28.0 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `tempfile`: 3.23.0 → 3.27.0 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
- `axum-test`: 18.1.0 → 20.0.0 ([#165](https://github.com/CramBL/fidelityfetch/pull/165))
...
- Add "download as Zip" button to directories
